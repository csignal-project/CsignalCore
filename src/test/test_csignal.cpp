...
#define BOOST_TEST_MODULE CSIGNAL Test Suite

#include "test_csignal.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_csignal_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
