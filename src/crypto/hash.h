...
// Copyright (c) 2009-2014 The CSIGNAL developers
// Copyright (c) 2014-2015 The CSIGNAL developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef CSIGNAL_HASH_H
#define CSIGNAL_HASH_H

#include "../serialize.h"
#include "../uint256.h"
#include "../version.h"
#include "../chainparams.h" // for LogPrintf CSIGNALDev
