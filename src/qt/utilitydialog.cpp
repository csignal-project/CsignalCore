    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("CSIGNAL Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About CSIGNAL Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  csignal-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the CSIGNAL in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an innovative process to mix your inputs with the inputs of two other csignal, without having your coins ever leave your wallet. \
...
These denominations are 0.01 CSG, 0.1 CSG, 1 CSG and 10 CSG -- sort of like the paper money you use every day.</li> \
...
<li>When two other csignal send similar messages, indicating that they wish to mix the same denomination, a mixing session begins. \
...
For more info see <a href=\"https://CSIGNALDev.atlassian.net/wiki/display/DOC/PrivateSend\">https://CSIGNALDev.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("CSIGNAL Core is shutting down...") + "<br /><br />" +
