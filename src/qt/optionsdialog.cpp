    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("CSG-light"), QVariant("light"));
    ui->theme->addItem(QString("CSG-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("CSG-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("CSG-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("CSG-traditional"), QVariant("trad"));
