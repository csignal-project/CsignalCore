    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("CSIGNAL Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CSIGNAL address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and csignal: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About CSIGNAL Core"), this);
    aboutAction->setStatusTip(tr("Show information about CSIGNAL Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CSIGNAL Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CSIGNAL addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CSIGNAL addresses"));
    ...
    openAction->setStatusTip(tr("Open a csignal: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CSIGNAL Core help message to get a list with possible CSIGNAL Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("CSIGNAL Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CSIGNAL network", "", count));
    } else {
...
{
    QString strTitle = tr("CSIGNAL Core"); // default title
