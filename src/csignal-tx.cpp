...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("CSIGNAL Core csignal-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  csignal-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded csignal transaction") + "\n" +
              "  csignal-tx [options] -create [commands]   " + _("Create hex-encoded csignal transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded csignal transaction
