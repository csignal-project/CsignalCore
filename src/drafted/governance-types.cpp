...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "CSIGNALNetwork") type = CSIGNALNetwork;
    if(strType == "CSIGNALNetworkVariable") type = CSIGNALNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == CSIGNALNetwork) s = "CSIGNALNetwork";
    if(type == CSIGNALNetworkVariable) s = "CSIGNALNetworkVariable";
