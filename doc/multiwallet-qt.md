...
Only requiring some minor changes is csignal.cpp.
...
Changes to csignal.cpp
----------------------
csignal.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
