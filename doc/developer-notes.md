...
CSIGNAL Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 45450.
...
However, in open source software such as CSIGNAL Core, where everyone uses
...
pay attention to for reviewers of CSIGNAL Core code.

General CSIGNAL Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: CSIGNAL Core uses tinyformat, which is type safe. Leave them out to avoid confusion
