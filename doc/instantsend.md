...
This mechanism has been integrated into Bitcore-Node-CSIGNAL which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/csignalproject/insight-api-csignal#web-socket-api](https://github.com/csignalproject/insight-api-csignal#web-socket-api)
* API: [https://github.com/csignalproject/insight-api-csignal#instantsend-transactions](https://github.com/csignalproject/insight-api-csignal#instantsend-transactions)
...
By default, the CSIGNAL Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CSIGNAL Core daemon:
